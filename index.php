...
<body>
    <div class="container-fluid bg-light p-5 text-center my-3">
        <h1 class="">Covid-19 Counter</h1>
        <h5 class="text-muted">It keep track of all the COVID-19 cases around the world.</h5>
    </div>
    ...
    <div class="container bg-light p-3 my-5 text-center">
        ...
        <p class="text-muted">Stay In Home And Stay Safe.</p>
    </div>
    ...
    <footer class="footer mt-auto py-3 bg-light">
        <div class="container text-center">
            <span class="text-muted">Made With <i class="far fa-heart"></i> By Tricky &copy</a></span>
        </div>
    </footer>
